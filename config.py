...
BLINK_SMOOTHING = 0.15

# Mouth expression thresholds
MOUTH_OPEN_THRESHOLD = 0.02  # Mouth starts opening
MOUTH_SMILE_THRESHOLD = 0.5  # Width/height ratio for smile
...
MIN_SCALE = 0.6
MAX_SCALE = 1.8
REFERENCE_DISTANCE = 0.4  # Reference shoulder width for scaling
